...
class IdentityController extends Controller
{
    ...
    public function storeApp(Request $request)
    {
        ...
        try{
            ...
            Image::make($request->get('front_image'))->save(public_path('images/products/').$fileNameFrontImage);
        ...
        if($request->get('back_image')){
            ...
            try{
                ...
                Image::make($request->get('back_image'))->save(public_path('images/products/').$fileNameRearImage);
