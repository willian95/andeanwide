    ...
    <div class="row">
        <div class="col-12">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('panel.admin.currencies.update', ['currency' => $currency->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group form-check">
                                    <input type="checkbox" class="form-check-input" id="can_send" name="can_send" value="1" {{ $currency->can_send == 1 ? 'checked' : '' }}>
                                    <label class="form-check-label" for="can_send">Se pueden hacer envios en esta divisa.</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group form-check">
                                    <input type="checkbox" class="form-check-input" id="can_receive" name="can_receive" value="1" {{ $currency->can_receive == 1 ? 'checked' : '' }}>
                        ...
                        <div class="row justify-content-center mt-4">
                            <div class="col-6 col-md-3">
                                <a href="{{ route('panel.admin.currencies.show', ['currency' => $currency->id]) }}" class="btn btn-outline-dark btn-block">Cancelar</a>
                            </div>
                            <div class="col-6 col-md-3">
