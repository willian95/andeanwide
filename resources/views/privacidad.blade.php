...
@section('content')
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="bg-white pt-2 pb-2">Políticas de Privacidad</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="/">Inicio</a><i class="fa fa-angle-double-right"></i><span>Políticas de privacidad</span>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    ...
                    <div class="text-container last">
                        ...
                        <a class="btn-outline-reg" href="/">atrás</a>
                    </div> <!-- end of text-container -->
                </div>
            </div> <!-- end of row -->
        </div> <!-- end of container -->
